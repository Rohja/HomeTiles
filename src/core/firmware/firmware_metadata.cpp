...
#elif defined(DEVICE_WAVESHARE_S3_TOUCH_LCD_7)
#define FW_META_TARGET_DEVICE_KEY "waveshare_s3_touch_lcd_7"
#define FW_META_TARGET_DISPLAY_NAME "Waveshare ESP32-S3 Touch LCD 7"
